...
test.describe('SA-cost-governance Page Tests', () => {
  ...
  test('Scheduled Search Governance page loads (governance_dashboard)', async ({ page }) => {
    ...
    const response = await page.goto(`${SPLUNK_URL}/en-US/app/SA-cost-governance/governance_dashboard`);
  ...
  test('Governance Settings page loads (governance_settings)', async ({ page }) => {
    ...
    const response = await page.goto(`${SPLUNK_URL}/en-US/app/SA-cost-governance/governance_settings`);
  ...
  test('Cost Analysis page loads (cost_analysis)', async ({ page }) => {
    ...
    const response = await page.goto(`${SPLUNK_URL}/en-US/app/SA-cost-governance/cost_analysis`);
  ...
  test('Dashboard Governance page loads (dashboard_governance)', async ({ page }) => {
    ...
    const response = await page.goto(`${SPLUNK_URL}/en-US/app/SA-cost-governance/dashboard_governance`);
  ...
  test('Audit History page loads (audit_history)', async ({ page }) => {
    ...
    const response = await page.goto(`${SPLUNK_URL}/en-US/app/SA-cost-governance/audit_history`);
